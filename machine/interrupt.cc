...
int Interrupt::CreateFile(char *name, int size) {
    return kernel->fileSystem->Create(name, size);
}

int Interrupt::WriteFile(char *buffer, int size, OpenFileId id) {
    return kernel->fileSystem->currFile->Write(buffer, size);
}
int Interrupt::ReadFile(char *buffer, int size, OpenFileId id) {
    return kernel->fileSystem->currFile->Read(buffer, size);
}
int Interrupt::CloseFile(OpenFileId id) {
    return kernel->fileSystem->CloseAFile(id);
}
OpenFileId Interrupt::OpenFile(char *name) {
